...
urlpatterns = [
                  ...
                  url(r'^strategy/(?P<pk>[0-9]+)/$', main_view.StrategyDetailView.as_view(), name='detail'),
                  url(r'^follow_strategy/(?P<sid>[0-9]+)/$', main_view.follow_strategy, name='follow_strategy'),
                  url(r'^like_strategy/(?P<sid>[0-9]+)/$', main_view.like_strategy, name='like_strategy'),
                  url(r'^my/strategy/', main_view.FollowIndexView.as_view(), name='my_strategy'),
